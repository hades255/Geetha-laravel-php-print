  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="row">
        ...
        <div
          class="col-md-4   @if($contact->type=='supplier' && !array_key_exists('supplier_tax_number', $contact_fields)) hide @endif">
          <div class="form-group">
        ...
        <div class="clearfix"></div>
        <div
          class="col-md-12  @if($contact->type=='supplier' && !array_key_exists('supplier_address', $contact_fields)) hide @endif">
          <div class="form-group">
