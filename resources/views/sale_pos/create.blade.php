                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="datetime-local" 
                                               value="{{ !empty($temp_data->transaction_date) ? \Carbon\Carbon::parse($temp_data->transaction_date)->format('Y-m-d\TH:i:s') : \Carbon\Carbon::parse($default_datetime)->format('Y-m-d\TH:i:s') }}" 
