            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    @foreach($sell as $payment_line)
                        <div class="col-sm-4 text-right">{{$payment_line->invoice_no}}</div>
                        <div class="col-sm-4 text-right">{{number_format(($payment_line->account_transctions() ? $payment_line->account_transctions()->interest : 0), $company->currency_precision)}}</div>
