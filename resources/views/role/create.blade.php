    ...
    <section class="content pos-tab-container">
        @component('components.widget', ['class' => 'box-primary'])
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'DailyReviewAll', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'DailyReviewOne', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'bypass.review', false,
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'access.spreadsheet', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'create.spreadsheet', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'edit.spreadsheet', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'delete.spreadsheet', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'toggle.spreadsheet', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'download.spreadsheet', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'create.folder', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'edit.folder', false,
                ...
                <div class="row check_group">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'add.payments', false,['class' => 'input-icheck']); !!}
                         ...
                         <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'purchase.edit.payments', false,['class' => 'input-icheck']); !!}
                         ...
                         <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'purchase.delete.payments', false,['class' => 'input-icheck']); !!}
            ...
            <div class="row check_group">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'stockAdjustment.edit',
                        ...
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'stockAdjustment.delete',
                        ...
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'stockAdjustment.list',
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'backup.restore', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'backup.upload', false,
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'DashboardSummaryCards', true,
                                [ 'class' => 'input-icheck']); !!} 
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'DashboardPaymentMethods', true,
                                [ 'class' => 'input-icheck']); !!} 
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'DashboardProductCategories',true,
                                [ 'class' => 'input-icheck']); !!} 
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'DashboardGlance', true,
                                [ 'class' => 'input-icheck']); !!} 
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'DashboardCurrentPastGraph', true,
                                [ 'class' => 'input-icheck']); !!} 
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'DashboardCurrentPastPayments', true,
                                [ 'class' => 'input-icheck']); !!} 
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                     ...
                     <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'account.unreconcile', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'edit.cheque_ob', false,
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'delete.cheque_ob', false,
            ...
            @if($get_permissions['contact_module'])
                ...
                <hr>
            @endif
            @if($get_permissions['edit_received_outstanding'])
                <div class="row check_group">
                    <div class="col-md-1">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'add_received_outstanding', false,
            ...
            @if($get_permissions['enable_petro_module'])
                ...
                <div class="row check_group">
                    ...
                    <div class="col-md-9">
                        ...
                        @if($get_permissions['delete_settlement'])
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'settlement.delete', false,
            ...
            <div class="row check_group">
                    ...
                    <div class="col-md-9">
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'essentials.crud_all_attendance', false,
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'essentials.view_own_attendance', false,
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'essentials.allow_users_for_attendance_from_web', false,
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'essentials.view_allowance_and_deduction', false,
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'essentials.crud_all_leave', false,
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'essentials.crud_own_leave', false,
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'essentials.crud_leave_type', false,
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'essentials.view_all_payroll', false,
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'essentials.create_payroll', false,
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'essentials.update_payroll', false,
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'essentials.delete_payroll', false,
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'essentials.access_sales_target', false,
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'essentials.edit_todos', false,
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'essentials.delete_todos', false,
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'essentials.add_todos', false,
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'edit_essentials_settings', false,['class' => 'input-icheck']); !!} {{ __('essentials::lang.edit_essentials_settings') }}
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'essentials.crud_department', false,
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'essentials.crud_designation', false,
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'add_essentials_leave_type', false,['class' => 'input-icheck']); !!} {{ __('essentials::lang.add_essentials_leave_type') }}
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'essentials.create_message', false,
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'essentials.view_message', false,
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'essentials.approve_leave', false,
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'essentials.assign_todos', false,
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('permissions[]', 'essentials.add_allowance_and_deduction', false,
                ...
                <div class="row check_group">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'property.approve_commission', false ,
                        ...
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'property.update_sale_commission',  false ,
                        ...
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'property.update_commission_status',  false ,
