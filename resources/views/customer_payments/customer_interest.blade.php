            ...
            @component('components.filters', ['title' => __('report.filters')])
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        {!! Form::text('customer_payment_date_range', null, ['class' => 'form-control ','id'=>'customer_interest_date_range', 'style' => 'width: 100%;']); !!}
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('customer_payment_init_id', __('lang_v1.customer').':') !!}
                        {!! Form::select('customer_payment_init_id', $customers, null, ['class' => 'form-control
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        {!! Form::select('paid_in_type', ['customer_bulk' => "Customer Bulk Page",'customer_page' => 'Customer Page', 'all_sale_page' => 'All Sale Page', 'settlement' => 'Settlement'], 'customer_bulk', ['class' => 'form-control select2', 'style' => 'width: 100%;', 'placeholder' => __('lang_v1.all')]); !!}
