...
@section('javascript')
    ...
    <script>
        ...
        $(document).on('change', '.interest_selection_checkbox, .amount_selection_box', function () {
            ...
            // let excess_amount = $('#payable_amount').val();
            // let transactionId = $(this).closest('tr').find('.paying_checkbox ').data('id');
            ...
            //     }
            // }
            // if($(this).closest('tr').find('.paying_checkbox ').is(":checked")) {
            //     if(excess_amount < totalAmount){

            //     $('#total_amount_'+transactionId).val(excess_amount);
            //     }else{
            ...
            //     let inputVal = $(this).closest('tr').find('.paying_checkbox ').val();
            //     if(!isNaN(inputVal)) {
        ...
        $(document).on('click', '.paying_checkbox', function () {
            ...
            if($(this).is(":checked")) {
                ...
                $('#total_amount_'+transactionId).val(excess_amount.toFixed(2));
                }else{

                $('#total_amount_'+transactionId).val(totalAmount.toFixed(2));
                }
            } else {
                $('#total_amount_'+transactionId).val('');
            }
