    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
              ...
              <div class="form-group">
                  ...
                  <select name="account_type_id" class="form-control select2 account_type_id" id="account_type_id">\
              ...
              <div class="form-group asset_type">
                  ...
                  {!! Form::select('asset_type', [], null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control asset_type_input']) !!}
              </div>
           ...
           var this_val = parseInt($(this).val());
            $.ajax({
                ...
                success: function(result) {
                    $('.asset_type_input').empty().append(result);
                },
            });
      });
      $('#account_type_id').change(function(){
