<div class="modal-dialog" role="document">
  ...
  <div class="modal-body">
    ...
    <div class="form-group">
          {!! Form::label('show_status', __( 'account.show_status' ) .":") !!}
          <select name="show_status" class="form-control select2" id="show_status" required>
            <option value="0" @if($account_group->show_status == "0") selected @endif >@lang('messages.no')</option>
            <option value="1" @if($account_group->show_status == "1") selected @endif >@lang('messages.yes')</option>
          </select>
      </div>
