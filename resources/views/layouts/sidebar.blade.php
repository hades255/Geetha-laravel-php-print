...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            @if ($is_admin)
            <li class="treeview {{ in_array($request->segment(1), ['patient','medication']) ? 'active active-sub' : '' }}">
                <a href="#">
                    <i class="fa fa-connectdevelop"></i>
                    <span class="title">@lang('patient.module_name')</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li class="{{ $request->segment(1) == 'patient' ? 'active' : '' }}">
                        <a href="{{action('PatientController@index')}}"><i class="fa fa-dashboard"></i> @lang('patient.home')</a>
                    </li>
                    <li class="{{ $request->segment(1) == 'medication' ? 'active' : '' }}">
                        <a href="{{action('MedicationController@index')}}"><i class="fa fa-dashboard"></i> @lang('patient.medications')</a>
                    </li>
                </ul>
            </li>
            <li class="treeview {{ in_array($request->segment(1), ['patient-test-records']) ? 'active active-sub' : '' }}">
                <a href="#">
                    <i class="fa fa-connectdevelop"></i>
                    <span class="title">@lang('patient.test_records.module_name')</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li class="{{ $request->segment(1) == 'patient' ? 'active' : '' }}">
                        <a href="{{action('PatientController@index')}}"><i class="fa fa-dashboard"></i> @lang('patient.test_records.sugar_testing')</a>
                    </li>
                    <li class="{{ $request->segment(1) == 'patient' ? 'active' : '' }}">
                        <a href="{{action('PatientController@index')}}"><i class="fa fa-dashboard"></i> @lang('patient.test_records.pressure_testing')</a>
                    </li>
                </ul>
            </li>
            @endif
            ...
            @if($petro_quota_module)
                <li class="treeview {{ in_array($request->segment(1), ['vehicles']) ? 'active active-sub' : '' }}"
                    id="tour_step5">
                    <a href="#" id="tour_step5_menu">
                        <i class="fa fa-car"></i> <span>@lang('vehicle.petro_quota')</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li class="{{ $request->segment(1) == 'vehicle' && $request->segment(2) == '' ? 'active' : '' }}">
                            <a href="{{action('\Modules\Petro\Http\Controllers\VehicleController@index')}}"><i class="fa fa-list"></i>@lang('vehicle.petro_quota')</a>
                        </li>
                        <li class="{{ $request->segment(1) == 'vehicles' && $request->segment(2) == '' ? 'active' : '' }}">
                            <a href="{{action('\Modules\Petro\Http\Controllers\VehicleController@vehicles_list')}}"><i class="fa fa-plus-circle"></i>@lang('vehicle.registered_vehicle_details')</a>
                        </li>
            ...
            <li class="{{ $request->segment(1) == 'repair' ? 'active' : '' }}">
                <a href="{{action('\Modules\AutoRepairServices\Http\Controllers\DashboardController@index')}}"><i class="fa fa-wrench"></i><span>@lang('lang_v1.auto_repair_services')</span></a>
            </li>
            ...
            <li class="treeview {{  in_array( $request->segment(1), ['cheque-templates', 'cheque-write', 'stamps', 'cheque-numbers','payees','deleted_cheque_details','printed_cheque_details','default_setting']) ? 'active active-sub' : '' }}" id="" style="background: brown;">
                <a href="#" id="">
                ...
                <ul class="treeview-menu">
                    ...
                    @endif
                    @if($manage_payee)
                   <li class="{{ $request->segment(1) == 'payees' && $request->segment(2) == '' ? 'active' : '' }}">
                        <a href="{{url('payees')}}"><i class="fa fa-money"></i>Manage Payee</a>
                    </li>
                    @endif
                    ...
                    <li class="{{ $request->segment(1) == 'printed_cheque_details' && $request->segment(2) == '' ? 'active' : '' }}">
                        <a href="{{url('printed_cheque_details')}}"><i class="fa fa-print"></i>Printed Cheque Details</a>
                    </li>
                    @endif
                    @if($default_setting)
                     <li class="{{ $request->segment(1) == 'default_setting' && $request->segment(2) == '' ? 'active' : '' }}">
                        <a href="{{url('default_setting')}}"><i class="fa fa-cog"></i>Default Settings</a>
                    </li>
                    @endif
                </ul>
            </li>
