...
<script src="{{ asset('v2/js/metisMenu.min.js') }} "></script>
<script src="{{ asset('v2/js/jquery.slimscroll.min.js') }} "></script>
<script src="{{ asset('v2/js/jquery.slicknav.min.js') }} "></script>
