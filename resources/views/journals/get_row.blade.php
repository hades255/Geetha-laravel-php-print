<div class="row journal_row">
    ...
    <div class="col-md-2">
        <div class="form-group">
            {!! Form::text('journal['.$index.'][debit_amount]', null, [ 'class' => 'form-control debit-top debit_amount'.$index, 'id' => 'debit'.$index,
            'requried' , 'placeholder' => __('account.amount')]) !!}
        </div>
    </div>
    <div class="col-md-2">
        <div class="form-group">
            {!! Form::text('journal['.$index.'][credit_amount]', null, [ 'class' => 'form-control credit-top credit_amount'.$index,'id' => 'credit'.$index,
            'requried' , 'placeholder' => __('account.amount')]) !!}
        </div>
    </div>
