        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('account_type', $account_types, null, ['id'=>'account_type','class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.please_select')]); !!}
                </div>
                <div class="form-group">
                    {!! Form::label('account_sub_type',  __('Account Sub Type') . ':') !!}
                    {!! Form::select('account_sub_type', [], null, ['id'=>'account_sub_type','class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.please_select')]); !!}
                </div>
                <div class="form-group">
                    {!! Form::label('discount_account',  __('Discount Account') . ':*') !!}
                    {!! Form::select('discount_account', $discount_accounts, null, ['id'=>'discount_account','class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.please_select'),'required']); !!}
                </div>
                <div class="form-group">
