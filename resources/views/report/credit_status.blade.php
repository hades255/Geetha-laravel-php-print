...
<style>
    .timerange{
        background-color: #B66EAA !important; color: #fff !important;
    }
    
    .timerange.active{
        background-color: #800080 !important; color: #fff !important;
    }
</style>
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-xs-6">
            <div class="btn-group pull-right" data-toggle="buttons">
                <label class="timerange btn  @if(request()->period == 1 || empty(request()->period ) ) active @endif ">
                ...
                <label class="timerange btn  @if(request()->period == 365 ) active @endif ">
