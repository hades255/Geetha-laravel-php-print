...
<section class="content-header"  style="margin-top: 0px !important; padding-top: 0px !important; padding-bottom: 0px !important;">
...
<div class="col-md-12">
    ...
    <!--<div class="col-md-2">--> <!-- @eng START 14/2 -->
    <!--    <div class="form-group">
    ...
    <div class="col-md-3">
        <div class="form-group">
          {!! Form::label('monthly_report_date_range', __('report.date_range') . ':') !!}
          <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
            {!! Form::text('monthly_report_date_range', null, ['class' => 'form-control', 'readonly', 'placeholder' => __('report.date_range'), 'id' => 'monthly_report_date_rage']) !!}
          </div>
        </div>        
    </div>
    <!-- @eng END 14/2 -->    
...
<div class="monthly_report_content">
