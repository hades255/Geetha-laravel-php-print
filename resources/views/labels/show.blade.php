    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('barcode.print_labels') @show_tooltip(__('tooltip.print_label'))</h4>
                <ul class="breadcrumbs pull-left" style="margin-top: 15px">
                    <li><a href="#">Products</a></li>
                    <li><span>@lang('barcode.print_labels') @show_tooltip(__('tooltip.print_label'))</span></li>
                </ul>
            </div>
        </div>
    </div>
