            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text" style="font-size: 20px; color: black;">{{ $patient->user->username }}</span>
                        <span class="info-box-text" style="font-size: 15px; color: black;">{{ $patient->user->first_name }}</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
