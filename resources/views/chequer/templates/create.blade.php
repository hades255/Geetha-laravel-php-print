...
<section class="content">
    ...
    <div class="col-md-12 main">
        ...
        <div class="row panel-body" style="padding: 5px;">
            ...
            <!-- Added Not NEgotiable and A/C pay only -->
            <div class="col-md-2 margbotm3">
                <input type="checkbox" id="addpayonly" style="" onclick="acpayeeonly()"> <label>A/C payee only</label>
            </div>
            <div class="col-md-2 margbotm3">
				<input type="checkbox" id="addnotnegotiable" style="" onclick="notnegotiable()"> <label>Not Negotiable</label>
            </div>
            <div class="col-md-1 margbotm3">
            ...
            <div class="col-md-12">
                <div class="cheque-container" id="wrapperDiv">
                    <div id="addtemplateimg" >
                        ...
                        <div id="negotiable" class="resizable draggable" contenteditable="false" style="position:absolute;color:black;margin-left: 175px;margin-top: 7px;background-image: url({{asset('chequer/img/Not-Negotiable.png')}});background-repeat: no-repeat;height: 30px; width: 120px;display: none; display: none;" onclick="get_aligmentnego();">
                            <!-- <img src="{{asset('chequer/img/Not-Negotiable.png')}}" style="width: 100%;"> -->
                        </div>
                        <div id="payonly" class="resizable draggable" contenteditable="false" style="position:absolute;color:black;margin-left: 50px;margin-top: 7px; background-image: url({{asset('chequer/img/pay-only.png')}});background-repeat: no-repeat;height: 30px; width: 120px;display: none; display: none;" onclick="get_aligmentpayonly();">
...
<script>
    ...
    //Enable/Disable image for payee and not negotiable
    function notnegotiable() {
