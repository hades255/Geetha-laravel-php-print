...
class Util
{
     ...
     * @return array
     */
    public function payment_types($location = null, $merge_cash_group_accounts = false, $add_credit_purchase = false, $add_credit_expense = false, $add_credit_sale = false, $is_company = false)
    {
        $payment_types = [
            'cash' => __('lang_v1.cash'),
            'card' => __('lang_v1.card'),
            'company_cards' => __('lang_v1.company_cards'),
            'cheque' => __('lang_v1.cheque'),
            'direct_bank_deposit' => __('lang_v1.direct_bank_deposit'),
            'bank_transfer' => __('lang_v1.bank'),
            'other' => __('lang_v1.other')
        ];
        if ($is_company) unset($payment_types['card']);
        else unset($payment_types['company_cards']);
        ...
        //         $payment_types = $this->array_merge_recursive_distinct($payment_types, $cash_group_accounts);
        //     }
        // }
        if ($add_credit_sale) {
