...
class ChequeNumberController extends Controller
{
    ...
    public function printedcheque(Request $request)
    {
        ...
        $printedcheque = $printedcheque->select('printed_cheque_details.*', 'chequer_bank_accounts.bank','users.username','transactions.type','transactions.ref_no','transactions.invoice_no','contacts.name')
