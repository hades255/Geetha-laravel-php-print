            ...
            return Datatables::of($contacts)
                ->addColumn('action', function ($row) {
                    ...
                    if ($row->is_payee) {
                        ...
                        <li><a href="javascript:void(0);" data-toggle="modal" data-target="#myModal" data-id="' . $row->id . '"data-name="' . $row->name . '"data-active="' . $row->active . '"data-opening_balance="' . $row->opening_balance . '"class="edit_payee_button"><i class="glyphicon glyphicon-edit"></i> Edit</a></li>
