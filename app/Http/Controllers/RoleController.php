...
class RoleController extends Controller
{
    ...
    public function create()
    {
        ...
        $get_permissions['edit_received_outstanding'] = $this->moduleUtil->hasThePermissionInSubscription($business_id, 'edit_received_outstanding');
        $get_permissions['delete_settlement'] = $this->moduleUtil->hasThePermissionInSubscription($business_id, 'delete_settlement');

        return view('role.create')->with(compact('selling_price_groups', 'module_permissions', 'get_permissions'));
    }
