        ...
        if (request()->ajax()) {
            ...
            $datatable = Datatables::of($sells)
                ...
                ->editColumn(
                    'final_total',
                    function ($row) {
                        return '<span class="display_currency final-total" data-currency_symbol="true" data-orig-value="' .$row->final_total . '">' . $this->productUtil->num_f($row->final_total) . '</span>';
                    }
                )
                ->editColumn(
                    'tax_amount',
                    function ($row) {
                        return '<span class="display_currency total-tax" data-currency_symbol="true" data-orig-value="' .$row->tax_amount . '">' . $this->productUtil->num_f($row->tax_amount) . '</span>';
                    }
                )
                ->editColumn(
                    'total_paid',
                ...
                ->editColumn(
                    ...
                    function ($row) {
                        ...
                        return (string) view('sell.partials.payment_status', ['payment_status' => $pstatus, 'id' => $row->id]);
                    }
                )
                ->editColumn(
                ...
                ->addColumn('total_remaining', function ($row) {
                    ...
                    $total_remaining_html = '<span class="display_currency payment_due" data-currency_symbol="true" data-orig-value="' . $total_remaining . '">' . $this->productUtil->num_f($total_remaining) . '</span>';
