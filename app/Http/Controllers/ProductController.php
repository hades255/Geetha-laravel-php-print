    ...
    public function adjustStock()
    {
        ...
        foreach($bls as $bl){
            ...
            foreach($variations as $one){
                ...
                // if($one->product_id == 29){
                //     echo "Purchased : $sumQuantity <br> Purchase Returns: $sumQuantityReturned <br> Total sold : $sumQuantitySell <br> Sale return: $sumQuantityReturnedSell <br> Balance: $bal<br> Opening stock: $sumOp <br>Increased : $incr <br> Decreased: $decr<br> Purchase transfer: $sumPt<br>Sale transfer: $sumQuantityTr <br> Production purchase: $sumPr <br> Production sell: $sumQuantityPr";
                // }
