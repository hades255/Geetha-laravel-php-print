...
class ContactGroupController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('contact_group.create')->with(compact('help_explanations', 'price_groups', 'type', 'allAccounts', 'allAccountsType'));
    }
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('contact_group.edit')
                ->with(compact('contact_group', 'type', 'price_groups', 'allAccounts', 'allAccountsType', 'selectedAccount', 'selectedAccountType'));
        }
    }
