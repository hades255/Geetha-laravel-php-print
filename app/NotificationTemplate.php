...
class NotificationTemplate extends Model
{
    ...
    public static function customerNotifications()
    {
        ...
        return [
            ...
            'credit_sale' => [
                'name' => __('Credit Sale'),
                'extra_tags' => ['{business_name}', '{contact_name}', '{total_amount}',  '{due_amount}','{paid_amount}','{due_amount}','{invoice_number}','{cumulative_due_amount}']
            ],
            'payment_received' => [
    ...
    public static function generalNotifications()
    {
        return [
            ...
            'transaction_deleted' => [
                ...
                'extra_tags' => ['{transaction_type}', '{account_name}', '{amount}', '{transaction_date}','{invoice_no}','{staff}']
            ],
            'transaction_changed' => [
            ...
            'deposit' => [
                'name' => "Deposits",
                'extra_tags' => ['{amount}', '{account}', '{date}', '{staff}']
            ],
            'transfer' => [
                'name' => "Transfers",
                'extra_tags' => ['{amount}', '{account}', '{date}', '{staff}']
            ...
            'expense_created' => [
                'name' => "Expense Added",
                'extra_tags' => ['{ref}', '{amount}', '{account}','{staff}']
            ],
            'expense_deleted' => [
