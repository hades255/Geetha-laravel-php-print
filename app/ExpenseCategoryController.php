...
class ExpenseCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $expense_category = ExpenseCategory::leftjoin('accounts', 'expense_account', 'accounts.id')
                ->join('contacts', 'contacts.id', '=', 'expense_categories.payee_id')
    ...
    public function create()
    {
        ...
        $payees = Contact::where('is_payee', 1)->pluck('name', 'id');
        $payees[''] = 'No Payee';
        //dd($payees);

        return view('expense_category.create')->with(compact('expense_accounts', 'account_access', 'expense_account_id', 'quick_add', 'expense_categories', 'payees'));
    }
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('expense_category.edit')
                ->with(compact('expense_category', 'expense_accounts', 'expense_categories', 'payees'));
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (request()->ajax()) {
            try {
                $input = $request->only(['name', 'code', 'payee_id', 'expense_account', 'is_sub_category', 'parent_id']);
                $business_id = $request->session()->get('user.business_id');
